            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <form method="POST" action="{{ route('products.update', $product->product_id) }}"
                    ...
                    <div class="px-6 py-4">
                            ...
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <div class="mb-6">
                                    ...
                                    <input
                                        ...
                                        id="price" name="price" type="text" placeholder="Nhập giá bán" min="0"
                                        step="any" value="{{ old('price', $product->price) }}">
                                    @error('price')
                                        <p class="text-red-500 text-xs italic mt-1" style="color:red">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="px-6 py-4 border-t border-gray-200 flex items-center justify-end space-x-6">
