        ...
        <div class=" max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                <div class="mb-6">
                                    ...
                                    <input
                                        ...
                                        id="product-name" name="name" value="{{ old('name') }}" type="text"
                                ...
                                <div class="mb-6">
                                    ...
                                    <input
                                        ...
                                        id="price" name="price" type="number" placeholder="Nhập giá bán" min="0"
                                ...
                                <div class="mb-6">
                                    ...
                                    <select
                                        ...
                                        <option value="Đang bán"
                                            {{ old('payment_method') == 'Đang bán' ? 'selected' : '' }}>
                                            Đang bán</option>
                                        <option value="Ngừng bán"
                                            {{ old('payment_method') == 'Ngừng bán' ? 'selected' : '' }}>Ngừng bán
                                        </option>
                                        <option value="Hết hàng"
                                            {{ old('payment_method') == 'Hết hàng' ? 'selected' : '' }}>
                                            Hết hàng</option>
                                    </select>
                                    @error('status')
                                    <p class="text-red-500 text-xs italic mt-1" style="color:red">{{ $message }}</p>
                                    ...
                                    <div
                                        ...
                                        <div class="space-y-4">
                                            <div id="imageContainer"
                                                ...
                                                style="height: 200px;">
                                                <svg id="defaultImage" class="h-32 w-32 text-gray-400"
                    ...
                    <div class="px-6 py-4 border-t border-gray-200 flex items-center mb-2 justify-end space-x-6">
